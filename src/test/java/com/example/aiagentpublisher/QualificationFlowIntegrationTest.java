...
import com.example.aiagentpublisher.bot.TelegramBotStarter;
...
import com.example.aiagentpublisher.leads.TelegramSellerNotifier;
...
class QualificationFlowIntegrationTest {
    ...
    @Test
    void fullBuyerFlowPersistsLeadAndPingsSeller() throws TelegramApiException {
        ...
        assertThat(sellerNotifier).isInstanceOf(TelegramSellerNotifier.class);
